...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:3000", "http://localhost:3002"],  # React 서버 도메인
...
from model_query import find_similar_doc_from_db
...
def chatbot_query(query):
    ...
    """
    answer = find_similar_doc_from_db(query.user_messsage)
    return {
